...
public class CharacterDataSO : ScriptableObject
{
    ...
    [field: SerializeField, FoldoutGroup("Movement Variables")] public float RotationSpeed { get; private set; }
    
    [field: SerializeField, FoldoutGroup("Jump Variables")] public float JumpForce { get; private set; }
    [field: SerializeField, FoldoutGroup("Jump Variables")] public float FallMultiplier { get; private set; }
    [field: SerializeField, FoldoutGroup("Jump Variables")] public float LowJumpMultiplier { get; private set; }
